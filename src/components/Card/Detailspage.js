    ...
    return (
            ...
            <div className="container">
                <div className="row">
                    ...
                    {
                        filtt.map(final => <div className='col-md-6'>
                            <Card style={{ width: '18rem' }}>
                                <Card.Img variant="top" src={final?.cy1} />
                                <Card.Body>
                            ...
                            <Card style={{ width: '18rem' }}>
                                <Card.Img variant="top" src={final?.cy2} />
                                <Card.Body>
                                    <Card.Title>Card Title</Card.Title>
                                    <Card.Text>
                                        Some quick example text to build on the card title and make up the bulk of
